...
<p align="center">
  <a href="https://tarun-varshney.netlify.app/">
    <img alt="Tarun Varshney" src="./content/assets/name-icon.png" width="60" />
  </a>
</p>
<h1 align="center">
  Welcome to My Blog
...
- **For most developers, I recommend starting with my [basic tutorial for creating a blog with Gatsby](https://www.gatsbyjs.org/tutorial/).** It starts with zero assumptions about your level of understanding Gatsby and walks through every step of the process.
